"""
Django settings for Assyster_CollegeAssistant project.
...
SECRET_KEY = '-@_j30c)j_h!t^_2=l!8g96$^yjcg81c9ed=f=)^5@b(@khgg_'
...
WSGI_APPLICATION = 'Assyster_CollegeAssistant.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME':'Assyster_CollegeAssistant',
        'USER':'assyster_user',
        'PASSWORD':'password',
        'HOST':'localhost',
        'PORT':'3306'
